...
\item[(i)]  Orthogonal or nonorthogonal, according to the type of
  basis uses. Nonorthogonal are redunant at large scales, where
  wavelet spectrum at adjacent times is highly correlated. They are
...
\centering{\includegraphics[height=7cm]{various_wavelet}}
\end{itemize}
...
\centering{\includegraphics[height=3.5cm]{wavelet-phase}}
